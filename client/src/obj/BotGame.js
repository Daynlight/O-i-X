        ...
        <div>
            {Win!=='' &&
                <div className="">
                    ...
                    <div onClick={() => PlayAgain()} className="">Play Again</div>
                </div>
            }
            {Ture===0 && <div className="">
                <div className="" onClick={ () => {SetPlayer('x'); SetBot('o');BotMove('o'); SetTure(Ture+1)} }>
                    ...
                    <div className="" onClick={ () => {SetPlayer('o'); SetBot('x'); SetTure(Ture+1)} }>
            ...
            <div className="">
                ...
                ( e.Pose==='' && Win==='' && <div key={e.id} onClick={() => Game(e.id) } className=""></div>) ||
