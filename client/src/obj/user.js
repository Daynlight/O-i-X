                    ...
                    <ul class="friendlist col-12">
                        {Friends.map(e =>
                            (
                                ...
                                (Now-e.active<=(5*60)) && <li class="me-4 useractive" key={e.ID}>{e.Nick}
                            ...
                            (
                                ...
                                (Now-e.active>(5*60)) && (Now-e.active<=(10*60)) && <li class="me-4 unusersleep" key={e.ID}>{e.Nick}                    
                                    <svg fill="#ffe600" height="18" class="mb-1" width="23" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
                                    viewBox="0 0 489.4 489.4" >
                                    <g>
                                        <path d="M369.75,0h-250.2v44.3h-85.6V110c0,47.2,38.4,85.6,85.6,85.6h1.5c7.9,51.3,47,92.2,97.2,103v70.9h-30.7
                            ...
                            (
                                ...
                                (Now-e.active>(10*60)) && <li class="me-4 unuseractive" key={e.ID}>{e.Nick}
                                <svg fill="#ffe600" height="18" class="mb-1" width="23" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
                                    viewBox="0 0 489.4 489.4" >
                                    <g>
                                        <path d="M369.75,0h-250.2v44.3h-85.6V110c0,47.2,38.4,85.6,85.6,85.6h1.5c7.9,51.3,47,92.2,97.2,103v70.9h-30.7
